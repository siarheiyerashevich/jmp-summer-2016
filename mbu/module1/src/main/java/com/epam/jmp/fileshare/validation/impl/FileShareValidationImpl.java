...
/**
 * Created by nbuny on 20.07.2016. I want to create separate validator for each input parameter
 */
@Service
public class FileShareValidationImpl implements FileShareValidator {

    @Override
    public FileValidationResult validate(final byte[] fileData, final String fileName,
        ...
        if (extension == null) {
            validationResult.addErrorMessage(MessageFormat.format(
                    "Unrecognized file extension {0}", extension));
        }
